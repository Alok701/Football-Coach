      ...
      <div class="container">
        <div class="row align-items-center position-relative">
          <div class="col-md-6 text-center text-md-start mb-2 mb-md-0">
            <h1 class="breadcrumb-title mb-0 text-white">Product Detail</h1>
          </div>
          <div class="col-md-6">
            <ol class="breadcrumb d-flex justify-content-center justify-content-md-end ms-auto">
              <li class="breadcrumb-item"><a href="{{url('book')}}"><i class="fas fa-home me-1"></i>Home</a></li>
              <li class="breadcrumb-item active"><span>Product Detail</span></li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-md-7">
                <div class="product-detail">
                  ...
                  <a class="btn btn-primary btn-md" href="#">Add to cart </a>

...
<section class="space-ptb bg-holder bg-overlay-black-90" style="background-image: url('images/bg/inner-banner.jpg');">
                    ...
                    <option>IT & software</option>
                     ...
                     <option>Personal Development</option>
                      <option>Business</option>
                        ...
                        <div class="col-12 col-lg-3 text-start mt-3 mt-lg-0">
                    ...
                    <!-- <div class="widget">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="price-filter d-flex">
                                ...
                                <a class="ms-auto" href="#"><i class="fas fa-filter"></i>Filter</a>
                            </div>
                        </div>
                    </div> -->
                    <div class="widget">
                ...
                <div class="course-filter d-sm-flex mb-4">
                    ...
                    <!-- <ul class="course-view-list list-unstyled d-flex mb-0">
                        <li>
                            <form class="form-inline">
                                <div class="form-group d-sm-flex d-block align-items-center">
                                    <label class="justify-content-start pe-4">Sort by: </label>
                                    <div class="short-by">
                                        <select class="form-control basic-select">
                                            <option>12</option>
                                            <option>18 </option>
                ...
                <div class="row">
                        ...
                        <div class="course">
                            ...
                            <div class="course-info">
                                <div class="course-title">
                                    <a href="{{ url('course-details') }}">Basic web development & coding online course</a>
                                </div>
                    ...
                    <div class="col-sm-6 mb-4 pb-2">
                        <div class="course">
                            ...
                            <div class="course-info">
                                <div class="course-title">
                                    <a href="{{ url('course-details') }}">Great thinking devices to help you learn tough topics</a>
                                </div>
                                <div class="course-instructor">by
                                    <a >Alice Williams</a>
                                </div>

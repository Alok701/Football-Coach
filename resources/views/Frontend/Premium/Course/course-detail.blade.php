<x-frontend.premium.course.courseheader />
    ...
    <div class="container position-relative">
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start mb-2 mb-md-0">
                <h1 class="breadcrumb-title mb-0 text-white">Course Detail</h1>
            </div>
            <div class="col-md-6">
                <ol class="breadcrumb d-flex justify-content-center justify-content-md-end ms-auto">
                    ...
                    <li class="breadcrumb-item active"><span>Basic web development & coding online course</span></li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 col-xl-8">
                <h4 class="news-title mb-2">Basic web development & coding online course</h4>
                ...
                <div class="border mb-4">
                    ...
                    <div class="p-4 border-top">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <b class="display-4 text-warning fw-bold">3.5</b>
                        </div>
...
<x-frontend.premium.course.coursefooter />
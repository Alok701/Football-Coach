    ...
    <div class="container position-relative">
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start mb-2 mb-md-0">
                <h1 class="breadcrumb-title mb-0 text-white">Presentation Detail</h1>
            </div>
            <div class="col-md-6">
                <ol class="breadcrumb d-flex justify-content-center justify-content-md-end ms-auto">
                    ...
                    <li class="breadcrumb-item active"><span>Library (exercises, outlines etc)</span></li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <h4 class="news-title mb-2">Who We Are?</h4>
                <!--<div class="d-flex align-items-center">-->
                <!--    <span class="text-warning h6 mb-0 me-2">3.5</span>-->
                ...
                <!--    </ul>-->
                <!--</div>-->
                <!--<div><b class="me-2">Created by </b><a href="#">Alice Williams</a></div>-->
                <ul class="list-unstyled d-sm-flex mt-3 mb-4">
                    <!-- <li class="d-inline"><a class="btn btn-outline-dark-hover btn-sm me-3 mb-sm-0 mb-3" href="#">Wishlist</a></li> -->
                    ...
                    <!--<li class="d-inline"><a class="btn btn-outline-dark-hover btn-sm" href="#">View The Course</a></li>-->
                </ul>
                <ul class="list-unstyled d-flex flex-wrap mb-4">
                    <li class="course-d-Teacher me-3 me-lg-5 mb-2 mb-lg-0">
                        <div class="d-flex">
                            <img class="me-2 me-lg-3 mt-2" src="images/avatar/11.jpg" alt="">
                            <div class="d-block">
                ...
                <!-- <iframe class="border mb-5" style="width: 100%; height: 465px;" src="https://www.youtube.com/watch?v=EngW7tLk6R8" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                    <!--<iframe class="border mb-5" width="100%" height="465" src="https://www.youtube.com/embed/aqz-KE-bpKQ" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>-->
                    <!--<iframe src="https://onedrive.live.com/embed?resid=A71363330FDDA59F%21117&amp;authkey=!AD6pSy56nEVn-po&amp;em=2&amp;wdAr=1.7777777777777777" width="600px" height="300px" frameborder="0"><a target="_blank" href="https://office.com">Microsoft Office</a> presentation, powered by <a target="_blank" href="https://office.com/webapps">Office</a>.</iframe>-->
                    <!--<iframe src="https://onedrive.live.com/embed?resid=A71363330FDDA59F%21121&amp;authkey=!AFK7k-P1ozRErGM&amp;em=2&amp;wdAr=1.7777777777777777" width="476px" height="288px" frameborder="0">This is an embedded <a target="_blank" href="https://office.com"></a> <a target="_blank" href="https://office.com/webapps"> </a>.</iframe>-->
                   <iframe src="https://onedrive.live.com/embed?resid=A71363330FDDA59F%21115&amp;authkey=!AAxRII_n1B_uuO4&amp;em=2&amp;wdAr=1.7777777777777777" width="100%" height="500px" frameborder="0">This is an embedded <a target="_blank" href="https://office.com">Microsoft Office</a> presentation, powered by <a target="_blank" href="https://office.com/webapps">Office</a>.</iframe>
                    <div class="border mb-4">
                    <h6 class="text-dark px-4 py-2 bg-light mb-0">Description</h6>
                    <div class="p-4 border-top">
                        <span class="lead text-dark fw-6">Presentation Description</span>
                         <p class="mt-2">A complete solution for football federations, clubs, academies and schools</p>
                        <ul class="mb-4">
                            <li>All in one place.</li>
<li>Easy communication with the system.</li>
<li>Practical experience put into theory.</li>
<li>No updates required to the future.</li>
<li>Automatic procedures and configuration.</li>
<li>Always available for PC, Mobile and Tablet. </li>
                        </ul><!--<span class="lead text-dark fw-6">Main features</span>-->
                        <!--<ul class="list mt-2">-->
                ...
                <!--                <span class="me-4">Lecture 1 :</span>-->
                ...
                <!--            <li class="d-sm-flex align-items-center border-bottom pb-3 mb-3">-->
                <!--                <i class="flaticon-list-1 fa-sm me-2 text-primary"></i>-->
                <!--                <span class="me-4">Lecture 2 :</span>-->
                ...
                <!--                <i class="flaticon-list-1 fa-sm me-2 text-primary"></i>-->
                <!--                <span class="me-4">Lecture 3 :</span>-->
                ...
                <!--                            <span class="px-2 border text-success rounded-sm d-inline-block me-2">4.0</span>-->
                ...
                <!--                    <p>Then work backwards to develop the plan. What steps are required to get you to the goals? Make the plan as detailed as possible. Try to visualize and then plan.</p>-->
                                    <!-- <div class="d-sm-flex">
                <!--                        <a class="bg-light text-dark rounded-sm px-3 py-1 me-2 me-xl-4 font-sm d-inline-block mb-2 mb-sm-0" href="#"> <i class="fas fa-reply pe-1"></i> Reply Review </a>-->
                <!--                        <a class="bg-success-soft text-success rounded-sm px-3 py-1 me-2 me-xl-4 font-sm d-inline-block" href="#"> <i class="far fa-thumbs-up pe-1"></i> 56 Votes</a>-->
                <!--                        <a class="bg-danger-soft text-danger rounded-sm px-3 py-1 font-sm d-inline-block" href="#"> <i class="far fa-thumbs-down pe-1"></i> 06</a>-->
                <!--                    </div> -->
                <!--                </div>-->
                <!--            </div>-->
                <!--        </div>-->
                ...
                <!--        <div class="d-xl-inline-flex mt-4 mb-4">-->
                            <!-- <img class="me-3 media-img" src="../images/avatar/11.jpg" alt=""> -->
                <!--            <div class="media-body">-->
                <!--                <div class="px-xl-4 mt-3 mt-xl-0">-->
                <!--                    <div class="d-flex align-items-center">-->
                <!--                        <h6 class="mt-0">Alice Williams </h6>-->
                <!--                        <div class="d-flex ms-auto mb-3">-->
                <!--                            <span class="px-2 border text-success border-radius d-inline-block me-2">3.0</span>-->
                <!--                            <ul class="list-unstyled d-flex mb-0">-->
                <!--                                <li><i class="fas fa-star text-warning"></i></li>-->
                <!--                                <li><i class="fas fa-star text-warning"></i></li>-->
                <!--                                <li><i class="fas fa-star text-warning"></i></li>-->
                ...
                <!--                    <p>Along with your plans, you should consider developing an action orientation that will keep you motivated to move forward at all times This requires a little.</p>-->
                                    <!-- <div class="d-sm-flex">
                <!--                        <a class="bg-light text-dark rounded-sm px-3 py-1 me-2 me-xl-4 font-sm d-inline-block mb-2 mb-sm-0" href="#"> <i class="fas fa-reply pe-1"></i> Reply Review </a>-->
                <!--                        <a class="bg-success-soft text-success rounded-sm px-3 py-1 me-2 me-xl-4 font-sm d-inline-block" href="#"> <i class="far fa-thumbs-up pe-1"></i> 67 Votes</a>-->
                <!--                        <a class="bg-danger-soft text-danger rounded-sm px-3 py-1 font-sm d-inline-block" href="#"> <i class="far fa-thumbs-down pe-1"></i> 04</a>-->
                <!--                    </div> -->
                <!--                </div>-->
                <!--            </div>-->
                <!--        </div>-->
                ...
                <!--        <div class="d-xl-inline-flex">-->
                            <!-- <img class="me-3 media-img" src="../images/avatar/05.jpg" alt=""> -->
                <!--            <div class="media-body">-->
                <!--                <div class="px-xl-4 mt-3 mt-xl-0">-->
                <!--                    <div class="d-flex align-items-center">-->
                <!--                        <h6 class="mt-0">Mellissa Doe</h6>-->
                <!--                        <div class="d-flex ms-auto mb-3">-->
                <!--                            <span class="px-2 border text-success rounded-sm d-inline-block me-2">5.0</span>-->
                <!--                            <ul class="list-unstyled d-flex mb-0">-->
                <!--                                <li><i class="fas fa-star text-warning"></i></li>-->
                <!--                                <li><i class="fas fa-star text-warning"></i></li>-->
                <!--                                <li><i class="fas fa-star text-warning"></i></li>-->
                ...
                <!--                    <p>I coach my clients to practice the 3 D’s – Defer, Delegate or Delete. Can the particular activity be done later? Defer it! Can it be done by someone else? Delegate</p>-->
                                    <!-- <div class="d-sm-flex">
                <!--                        <a class="bg-light text-dark rounded-sm px-3 py-1 me-2 me-xl-4 font-sm d-inline-block mb-2 mb-sm-0" href="#"> <i class="fas fa-reply pe-1"></i> Reply Review </a>-->
                <!--                        <a class="bg-success-soft text-success rounded-sm px-3 py-1 me-2 me-xl-4 font-sm d-inline-block" href="#"> <i class="far fa-thumbs-up pe-1"></i> 48 Votes</a>-->
                <!--                        <a class="bg-danger-soft text-danger rounded-sm px-3 py-1 font-sm d-inline-block" href="#"> <i class="far fa-thumbs-down pe-1"></i> 09</a>-->
                <!--                    </div> -->
                <!--                </div>-->
                <!--            </div>-->
                <!--        </div>-->
            ...
            <!--    <div class="widgets">-->
                    ...
                    <!--        <a class="btn btn-primary" onclick="myFunction()" href="#">Add To cart</a>-->
                    <!--        <del class="dark-text ms-3">$149</del>-->
                    <!--        <span class="fw-bold text-success lead ms-3">$49</span>-->
                    <!--    </div>-->
                    <!--</div>-->
...
<!--=================================
    ...
    <script>
function myFunction() {
  alert("Please buy the premium verison for full access");
}
</script>

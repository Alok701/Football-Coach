    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <h4 class="news-title mb-2">Library (exercises, outlines etc)</h4>
                ...
                <!-- <iframe class="border mb-5" style="width: 100%; height: 465px;" src="https://www.youtube.com/watch?v=EngW7tLk6R8" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                    ...
                    <iframe src="https://onedrive.live.com/embed?resid=A71363330FDDA59F%21117&amp;authkey=!AD6pSy56nEVn-po&amp;em=2&amp;wdAr=1.7777777777777777" width="100%" height="500px" frameborder="0"><a target="_blank" href="https://office.com">Microsoft Office</a> presentation, powered by <a target="_blank" href="https://office.com/webapps">Office</a>.</iframe>
                    ...
                    <div class="p-4 border-top">
                        ...
                        <p class="mt-2">Library (exercises, outlines etc).</p>
                        <ul class="mb-4"> 
 <li>DIVISION OF EXERCISES (recommended by specialists)</li>
<li>DIVISION BY AGE CATEGORIES</li>
<li>GRAPHICS</li>
<li>ANIMATION</li>
<li>MOVIE</li>
<li>MOVIE 360' (coming soon)</li>
                        </ul>

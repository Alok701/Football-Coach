...
<body>
    ...
    <!--=================================
    Header -->
    <header class="header header-sticky is-sticky">
        <div class="conatiner px-3 px-md-5 top-header">
            ...
            <!--                        <i class="fa fa-bullhorn ico"></i>-->
            <!--                        <span class="cart-iconn1">Course</span>-->
            <!--                    </a>-->
            <!--                </li>-->
            <!--                <li class="cart dropdown">-->
            <!--                    <a href="{{url('coach-index')}}">-->
            <!--                        <i class="fas fa-graduation-cap ico"></i>-->
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav cs-gap">
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="{{ url('/book') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Home</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="{{ url('/about-us') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">About Us</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="{{ url('/shop') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Store</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="{{ url('/shop') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Book</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="{{ url('/shop') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Article</a>
                        </li>
                    
                       <!--  <li class="nav-item dropdown">
                            <a class="nav-link" href="#" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Order Training</a>
                        </li> -->
                        
                        <!-- <li class="nav-item dropdown">
                            <a class="nav-link" href="coach.php" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Coach</a>
                        </li> -->
                        <li class="nav-item dropdown">

    ...
    <header class="header header-sticky ">
        ...
        <nav class="navbar navbar-static-top navbar-expand-lg px-3 px-md-5">
            <div class="container-fluid position-relative px-0">
                ...
                <a class="navbar-brand" href="{{ url('coach-index') }}">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="{{ url('coach-index') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Home</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="{{ url('about-us') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">About Us</a>
                        </li>
                        <!--<li class="nav-item dropdown">-->
                        <!--    <a class="nav-link" href="{{ url('event') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Events</a>-->
                        <!--</li>-->
                       
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="{{ url('order-training') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Order Training</a>
                        </li>
                        
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="{{ url('coach-list') }}" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">Coach</a>
                        </li>
                        <li class="nav-item dropdown">

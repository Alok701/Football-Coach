...
<!-- Mirrored from pixelwibes.com/template/ebazar/html/dist/ui-elements/auth-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Feb 2023 06:46:12 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                                ...
                                <form class="row g-1 p-3 p-md-4">
                                    ...
                                    <div class="col-12 text-center mt-4">
                                        <a href="{{ url('/') }}" class="btn btn-lg btn-block btn-light lift text-uppercase" alt="SIGNUP">SIGN UP</a>
                                    </div>
                                    <div class="col-12 text-center mt-4">
                                        <span>Already have an account? <a href="{{ url('admin-login') }}" title="Sign in" class="text-secondary">Sign in here</a></span>
                                    </div>
                                </form>
                                <!-- End Form -->
